...
if __name__ == '__main__':
    ...
    experiment_dir = '/home/zsj/PycharmProjects/miccai-3d-teeth-seg/output/experiment_pct_rot_seg_0721/'
            ...
            for batch_i, batch_data in enumerate(tqdm.tqdm(test_loader)):
                ...
                if i % 5 == 0 and batch_i < 10:
                    ...
                    for ii in range(len(data)):
                        ...
                        np.savetxt(
                            f'/home/zsj/PycharmProjects/miccai-3d-teeth-seg/data/data_rot/vis_dense/{batch_i}_{ii}.txt', np.concatenate((origin_data, rot_data), axis=0))
                        # np.savetxt(
