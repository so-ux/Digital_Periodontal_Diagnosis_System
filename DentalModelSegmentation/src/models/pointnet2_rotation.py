...
if __name__ == '__main__':
    ...
    experiment_dir = '/IGIP/zsj/projects/miccai-3d-teeth-seg/output/experiment_pn2_rot_seg_0718/'
        ...
        for batch_i, batch_data in enumerate(tqdm.tqdm(train_loader)):
            ...
            if i % 5 == 0 and batch_i < 1:
                ...
                for ii in range(30):
                    ...
                    np.savetxt(
                        f'/IGIP/zsj/projects/miccai-3d-teeth-seg/data/data_rot/vis/train_{batch_i}_{ii}.txt', np.concatenate((origin_data, rot_data), axis=0))
            ...
            for batch_i, batch_data in enumerate(tqdm.tqdm(test_loader)):
                ...
                if i % 5 == 0 and batch_i < 10:
                    ...
                    for ii in range(len(data)):
                        ...
                        #np.savetxt(
                            #f'/IGIP/zsj/projects/miccai-3d-teeth-seg/data/data_rot/vis/{batch_i}_{ii}.txt', np.concatenate((origin_data, rot_data), axis=0))
                        np.savetxt(
