...
def model_func(patches, labels):
    ...
    seg = model(patches.transpose(2, 1).contiguous())[:, 0, :]

    loss_seg = nn.BCELoss()(seg, seg_mask)
...
if __name__ == '__main__':
    ...
    experiment_dir = '/IGIP/zsj/projects/miccai-3d-teeth-seg/output/experiment_refine_dgcnn/'
